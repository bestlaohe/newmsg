...
#define SX1278_SDNN GPIO_Pin_1 // ��λ���Ŷ���
#define SX1278_NIRQ GPIO_Pin_6 // ���Ŷ���

#define SX1278_NSS_DISABLE GPIO_SetBits(SX1278_GPIO, SX1278_NSS)
#define SX1278_NSS_ENABLE GPIO_ResetBits(SX1278_GPIO, SX1278_NSS) // ʹ��
...
#define SET_SX1278_RST() GPIO_SetBits(SX1278_GPIO, SX1278_SDNN)      // ��λ���Ŷ���
#define CLR_SX1278_RST() GPIO_ResetBits(SX1278_GPIO, SX1278_SDNN)    // ���ڽ� SX1278 ģ�����ڹػ�ģʽ
